    ...
    updateAllLabels() {
        ...
        if (footerEl) {
            footerEl.innerHTML = lang === 'bm'
                ? 'MeterCalc Pro v3.0 | Dibangunkan oleh <strong>Khirul Anuar</strong> | Untuk <strong>JAMAC Metering Sdn. Bhd.</strong>'
                : 'MeterCalc Pro v3.0 | Developed by <strong>Khirul Anuar</strong> | For <strong>JAMAC Metering Sdn. Bhd.</strong>';
        }
